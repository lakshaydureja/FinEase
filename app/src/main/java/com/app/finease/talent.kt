...
import com.app.finease.databinding.ActivityTalentBinding
import com.google.android.material.appbar.MaterialToolbar
import com.google.android.material.navigation.NavigationView
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*

class talent : AppCompatActivity() {
   ...
   private lateinit var talentContentList2 : ArrayList<talentContent>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button9.setOnClickListener{
            val intent= Intent(this,talentPost::class.java)
...
//               println(talentContentList2)
               binding.listview.adapter = ListingAdapter(this@talent,talentContentList2);
