...
class talentPost : AppCompatActivity() {


    private lateinit var binding: ActivityTalentPostBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTalentPostBinding.inflate(layoutInflater)
        ...
        binding.button9.setOnClickListener{
            ...
            database = FirebaseDatabase.getInstance("https://finease-188dc-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Talent")
            val tal= talentContent(imageId,title,name,fee,date,desc)
