...
import com.app.finease.databinding.ActivityTalentClickBinding
...
class talentClick : AppCompatActivity() {

    private lateinit var binding: ActivityTalentClickBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_talent_click)

        binding = ActivityTalentClickBinding.inflate(layoutInflater)
